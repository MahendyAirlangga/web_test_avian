...
@section('title', 'Daftar Area Sales')
            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-header bg-white py-3" style="border-bottom: 2px solid #f1f3f5;">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0 fw-bold">
                            <i class="fa fa-map-marked-alt me-2 text-primary"></i>Daftar Area Sales
                        </h5>
                ...
                <div class="card-body p-3">
                    <div class="table-responsive">
                        ...
                        <table id="table-area-sales" class="table table-hover align-middle w-100">
                            <thead>
                                <tr>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title"><i class="fa fa-plus me-2"></i> Tambah Area Sales</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            
            <form action="{{ route('create.area_sales') }}" method="POST">
                @csrf
                <div class="modal-body p-4">
                    ...
                    <div class="mb-3">
                        <label for="area_sales" class="form-label fw-bold">Nama Area Sales</label>
                        <input type="text"
                               id="area_sales"
                               name="area_sales"
                               class="form-control form-control-lg border-2"
                               placeholder="Masukkan Area Sales..."
                               required>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header bg-success text-white">
                <h5 class="modal-title"><i class="fa fa-file-excel me-2"></i> Import Excel Area Sales</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            
            <form action="{{ route('import.area_sales') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body p-4">
                    <div class="mb-3">
                    ...
                    <div class="bg-light p-3 rounded border border-dashed text-center">
                        ...
                        <div class="d-flex gap-2 justify-content-center">
                            ...
                            <span class="badge bg-secondary px-3 py-2 text-wrap">area_sales</span>
                        </div>
                    </div>
                </div>
                <div class="modal-footer bg-light border-0">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title"><i class="fa fa-edit me-2"></i>Update Area Sales</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('update.area_sales', $item->kode_toko) }}" method="POST">
                @csrf
                <input type="hidden" name="area_sales_lama" value="{{ $item->area_sales }}">
                <div class="modal-body py-4">
                    ...
                    <div class="mb-3">
                        <label for="area_sales_{{ $index }}" class="form-label fw-bold">Nama Area Sales</label>
                        <input type="text"
                               id="area_sales_{{ $index }}"
                               name="area_sales"
                               class="form-control form-control-lg border-2"
                               value="{{ $item->area_sales }}"
                               required>
                    </div>
                </div>
                <div class="modal-footer bg-light border-0">
...
<div class="modal fade" id="deleteModal{{ $index }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            ...
            <form action="{{ route('destroy.area_sales', $item->kode_toko) }}" method="POST">
                @csrf
                @method('DELETE')
                <input type="hidden" name="area_sales" value="{{ $item->area_sales }}">
                <div class="modal-body py-4 text-center">
                    <i class="fa fa-trash-alt text-danger fa-3x mb-3"></i>
                    <p class="mb-0 fs-6">Apakah Anda yakin ingin menghapus area <strong>{{ $item->area_sales }}</strong> untuk toko <strong>{{ $item->kode_toko }}</strong>?</p>
...
$(document).ready(function () {
    $('#table-area-sales').DataTable({
        ...
        language: {
            ...
            search: "",
            searchPlaceholder: " Cari area sales...",
